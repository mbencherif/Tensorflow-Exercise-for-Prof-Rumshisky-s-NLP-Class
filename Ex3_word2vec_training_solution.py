...
def word2vec(batch_gen):
    ...
    ################### Your Code Starts Here ##########################
        center_words = tf.placeholder(tf.int32, name='centers')
        target_words = tf.placeholder(tf.int32, name='targets')
    ################### Your Code Ends Here ##########################
    ...
    ################### Your Code Starts Here ##########################
        embed_matrix = tf.Variable(tf.random_uniform(shape=[VOCAB_SIZE, EMBED_SIZE], minval=-1, maxval=1),
                              name='weights')
    ################### Your Code Ends Here ##########################
...
def main():
    ...
    #print ("The process data is alright")
    word2vec(batch_gen)
